/*
  ══════════════════════════════════════════════════════
  server.js — Backend для PIXEL RPG (исправленная версия)
  Исправления: атомарные обновления, хеширование пароля, экранирование
  ══════════════════════════════════════════════════════
*/
...
app.post('/api/save', async (req, res) => {
  ...
  try {
    ...
    const inc = {};
    if (data.goldDelta !== undefined) inc['data.gold'] = Number(data.goldDelta) || 0;
    if (data.pixrDelta !== undefined) inc['data.pixr'] = Number(data.pixrDelta) || 0;
    if (data.gramDelta !== undefined) inc['data.gram'] = Number(data.gramDelta) || 0;
    if (data.xpDelta !== undefined) inc['data.xp'] = Number(data.xpDelta) || 0;
    if (data.killCountDelta !== undefined) inc['data.killCount'] = Number(data.killCountDelta) || 0;
    if (data.potionsDelta !== undefined) inc['data.potions'] = Number(data.potionsDelta) || 0;

    if (Object.keys(inc).length > 0) {
      updatePayload.$inc = inc;
    }

    if (data.charId !== undefined) updatePayload.$set.charId = data.charId || null;
    if (data.level !== undefined) updatePayload.$set.level = Number(data.level) || 1;
    if (data.cp !== undefined) updatePayload.$set.cp = Number(data.cp) || 0;
    if (data.floor !== undefined) updatePayload.$set.floor = Number(data.floor) || 1;
    if (data.inventory !== undefined) updatePayload.$set['data.inventory'] = data.inventory;
    if (data.equipped !== undefined) updatePayload.$set['data.equipped'] = data.equipped;
    if (data.upg !== undefined) updatePayload.$set['data.upg'] = data.upg;
    if (data.skills !== undefined) updatePayload.$set['data.skills'] = data.skills;
    if (data.potionLv !== undefined) updatePayload.$set['data.potionLv'] = Number(data.potionLv) || 0;
    if (data.potionThreshold !== undefined) updatePayload.$set['data.potionThreshold'] = Number(data.potionThreshold) || 30;
    if (data.bp !== undefined) updatePayload.$set['data.bp'] = data.bp;
    if (data.prem !== undefined) updatePayload.$set['data.prem'] = data.prem;
    if (data.boss !== undefined) updatePayload.$set['data.boss'] = data.boss;
    if (data.dailyTasks !== undefined) updatePayload.$set['data.dailyTasks'] = data.dailyTasks;
    if (data.specialTasksClaimed !== undefined) updatePayload.$set['data.specialTasksClaimed'] = data.specialTasksClaimed;
    if (data.invFilter !== undefined) updatePayload.$set['data.invFilter'] = data.invFilter;
    if (data.xpNeeded !== undefined) updatePayload.$set['data.xpNeeded'] = Number(data.xpNeeded) || 100;
    if (data.maxFloor !== undefined) updatePayload.$set['data.maxFloor'] = Number(data.maxFloor) || 1;
